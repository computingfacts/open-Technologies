...
<!--                                        <span class="comments"><a href="/blog.jsp?title=${p[1]}">comments(${p[9]})</a></span>-->
                    ...
                    <div class="navigation">
                        <div class="alignleft"><a href="/home.jsp?pageNumber=<%= pageNumber - 1%>" id="prev" >&larr; Older Entries</a></div>
                        <div class="alignright"><a href="/home.jsp?pageNumber=<%= pageNumber + 1%>" >Newer Entries &rarr;</a></div>
